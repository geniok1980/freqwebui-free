    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
          {t('compare.selectBots')}
          <span className="ml-2 text-sm font-normal text-gray-500 dark:text-gray-400">
            {t('compare.selectedCount', { count: selectedBots.length })}
          </span>
        </h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t('compare.performanceComparison')}
            </h2>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {/* Status */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('common.status')}</td>
                  {comparisonData.map(bot => (
                ...
                {/* Exchange */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.exchange')}</td>
                  {comparisonData.map(bot => (
                ...
                {/* Strategy */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.strategy')}</td>
                  {comparisonData.map(bot => (
                ...
                {/* Total Profit */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.totalProfit')}</td>
                  {comparisonData.map(bot => {
                ...
                {/* Total Profit % */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('compare.totalProfitPct')}</td>
                  {comparisonData.map(bot => {
                ...
                {/* Win Rate */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.winrate')}</td>
                  {comparisonData.map(bot => {
                ...
                {/* Total Trades */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.totalTrades')}</td>
                  {comparisonData.map(bot => {
                ...
                {/* Avg Duration */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.avgDuration')}</td>
                  {comparisonData.map(bot => {
                ...
                {/* Environment */}
                <tr>
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{t('bots.environment')}</td>
                  {comparisonData.map(bot => (
      ...
      {selectedBots.length < 2 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">
            {t('compare.selectMinTwo')}
          </h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {t('compare.selectMaxFive')}
          </p>
        </div>
      )}
    </div>
